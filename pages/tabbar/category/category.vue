	...
	<view>
		...
		<view class="category-list">
			...
			<scroll-view scroll-y="true" class="left">
				<view @tap="handleCategory(index)" :class="{'on':index == showCategoryIndex}" 
				class="row" v-for="(caregory,index) in caregoryList" :key="index">
					<view class="text">
			...
			<scroll-view scroll-y="true" class="right">
				<view class="category" v-for="(category,index) in caregoryList" 
				:key="category.id" v-show="index == showCategoryIndex">
				  <view class="banner">
		...
		methods: {
			initData() {
				this.request({
					...
					success: ((res) => {
						this.caregoryList = res.data;
						console.log(this.caregoryList);
					})
				});
			},
