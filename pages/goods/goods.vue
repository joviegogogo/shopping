<template>
	<view>
		...
		<!-- 模态框 -->
		<popupspec :goodsInfo="goodsInfo" :goodsData="goodsData" :spaceInfo="spaceInfo"></popupspec>
		<!-- 评价 -->
		<view class="info-box comments">
			...
			<view class="footer">
				...
				<view class="box" @tap="keep">
					...
					<view class="text">{{isKeep?"已收藏":''}}收藏</view>
				</view>
				<view class="btn">
				...
				uni.getStorage({
					...
					success:(res=>{
						...
						goodsList.forEach(goods=>{
							if(goods.goods_id == this.goodsInfo_id && goods.spec == this.goodsInfo.spec){
								//如果存在修改商品数量
